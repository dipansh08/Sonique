...
import 'package:sonique/services/playlist_download_service.dart';
...
import 'package:sonique/utilities/playlist_image_picker.dart';
            ...
            if (_playlist['source'] == 'user-created')
              IconButton(
                ...
                onPressed: () async {
                  ...
                  final url = 'sonique://playlist/custom/$encodedPlaylist';
